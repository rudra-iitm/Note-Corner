...
const CodeEditor = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col text-white'>
      <Select>
        <SelectTrigger className="w-[180px] h-[30px] absolute top-6 right-5 text-black">
      ...
      <textarea
        ...
        className='max-h-[350px] bg-[#555555] text-white rounded-2xl w-[98%] mx-auto resize-none p-3 mt-3'
      />
    </div>
  );
}
