/*
  ...
  - You are about to drop the column `titles` on the `Docknote` table. All the data in the column will be lost.
  - Added the required column `title` to the `Docknote` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Docknote" DROP COLUMN "titles",
